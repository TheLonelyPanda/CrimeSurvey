...
<body>
					...
					<div class="p-fluid p-formgrid p-grid">
						<div class="p-field p-col">
							...
							<div class="row">
								...
								<div class="col-lg-4">
									<input type="text" class="form-control" name="S1_1_2_TEXT" disabled />
								</div>
							</div>
								...
								<div class="col-lg-12">
									<div style="width: 50%; float:left;">
										...
										<div class="row" style=" padding-top: 13px;">
											...
											<label class="radio-inline col-form-label  col-lg-5">
												<input type="text" class="form-control" name="S1_1_3_1_TEXT_1" disabled />
											</label>
										</div>
										<div class="row">
											<label class="radio-inline" style="align-self: center;">แขวง</label>
											<label class="radio-inline col-form-label  col-lg-5">
												<input type="text" class="form-control" name="S1_1_3_1_TEXT_2" disabled />
											</label>
										</div>
										<div class="row">
											<label class="radio-inline" style="align-self: center;">เขตสถานีตำรวจ</label>
											<label class="radio-inline col-form-label  col-lg-5">
												<input type="text" class="form-control" name="S1_1_3_1_TEXT_3" disabled />
											</label>
										</div>
									</div>
									...
									<div style="width: 50%; float:right;">
										<div class="row" style="margin-left: 10px;">
											...
											<label class="radio-inline col-form-label  col-lg-5">
												<input type="text" class="form-control" name="S1_1_3_2_TEXT_1" disabled />
											</label>
										</div>
										<div class="row">
											<label class="radio-inline" style="align-self: center;">อำเภอ</label>
											<label class="radio-inline col-form-label  col-lg-5">
												<input type="text" class="form-control" name="S1_1_3_2_TEXT_2" disabled />
											</label>
										</div>
										<div class="row">
											<label class="radio-inline" style="align-self: center;">ตำบล</label>
											<label class="radio-inline col-form-label  col-lg-5">
												<input type="text" class="form-control" name="S1_1_3_2_TEXT_3" disabled />
											</label>
										</div>
										<div class="row">
											<label class="radio-inline" style="align-self: center;">เขตสถานีตำรวจ</label>
											<label class="radio-inline col-form-label  col-lg-5">
												<input type="text" class="form-control" name="S1_1_3_2_TEXT_4" disabled />
											</label>
										</div>
										<div class="row">
											<label class="radio-inline" style="align-self: center;">อบต./ท.ตำบล/ท.เมือง/ท.นคร</label>
											<label class="radio-inline col-form-label  col-lg-5">
												<input type="text" class="form-control" name="S1_1_3_2_TEXT_5" disabled />
											</label>
										</div>
									</div>
							...
							<div class="row">
								...
								<div class="col-lg-4">
									<input type="text" class="form-control" name="S1_1_4_TEXT" disabled />
								</div>
							</div>
					...
					<div class="p-fluid p-formgrid p-grid">
						<div class="p-field p-col">
							...
							<div class="row">
								...
								<div class="col-lg-4">
									<input type="text" class="form-control" name="S3_4_TEXT" disabled />
								</div>
							</div>
							...
							<div class="row">
								...
								<div class="col-lg-4">
									<input type="text" class="form-control" name="S3_5_TEXT" disabled />
								</div>
							</div>
							...
							<div class="row">
								...
								<div class="col-lg-12">
									<label class="col-form-label" >
										...
										<label class="radio-inline col-form-label  col-lg-8">
											<input type="text" class="form-control" name="S4_1_TEXT" disabled />
										</label>
									</label>
									<label class="radio-inline col-form-label  col-lg-3">
								...
								<div class="col-lg-12">
									...
									<label class=" col-form-label ">
										...
										<label class="radio-inline col-form-label  col-lg-6">
											<input type="text" class="form-control" name="S4_2_TEXT" disabled />
										</label>
									</label>
									<label class="radio-inline col-form-label  col-lg-3">
							...
							<div class="row" style="margin-left: 10px;">
								...
								<div class="col-lg-12">
									...
									<label class="col-form-label" >
										...
										<label class="radio-inline col-form-label  col-lg-6">
											<input type="text" class="form-control" name="S4_3_2_TEXT" disabled />
										</label>
										<label class="radio-inline" style="align-self: center;"> 
											บาท
										</label>
							...
							<div class="row" style="margin-left: 10px;">
								...
								<div class="col-lg-12">
									...
									<label class="col-form-label" >
										...
										<label class="radio-inline col-form-label  col-lg-5">
											<input type="text" class="form-control" name="S4_3_3_1_TEXT" disabled />
										</label>
										<label class="radio-inline" style="align-self: center;"> 
											บาท
										</label>
									...
									<label class="col-form-label" >
										...
										<label class="radio-inline col-form-label  col-lg-3">
											<input type="text" class="form-control" name="S4_3_3_2_TEXT" disabled />
										</label>
										<label class="radio-inline" style="align-self: center;"> 
											บาท
										</label>
									...
									<label class="col-form-label" >
										...
										<label class="radio-inline col-form-label  col-lg-2">
											<input type="text" class="form-control" name="S4_3_3_3_TEXT" disabled />
										</label>
										<label class="radio-inline" style="align-self: center;"> 
											บาท
										</label>
									...
									<label class="col-form-label" >
										...
										<label class="radio-inline col-form-label  col-lg-4">
											<input type="text" class="form-control" name="S4_3_3_4_TEXT" disabled />
										</label>
										<label class="radio-inline" style="align-self: center;"> 
											บาท
										</label>
									...
									<label class="col-form-label" >
										...
										<label class="radio-inline col-form-label  col-lg-3">
											<input type="text" class="form-control" name="S4_3_3_5_TEXT" disabled />
										</label>
										<label class="radio-inline" style="align-self: center;"> 
											บาท
										</label>
									...
									<label class="col-form-label" >
										...
										<label class="radio-inline col-form-label  col-lg-4">
											<input type="text" class="form-control" name="S4_3_3_6_TEXT" disabled />
										</label>
										<label class="radio-inline" style="align-self: center;"> 
											บาท
										</label>
									...
									<label class="col-form-label" >
										...
										<label class="radio-inline col-form-label  col-lg-3">
											<input type="text" class="form-control" name="S4_3_3_7_TEXT" disabled />
										</label>
										<label class="radio-inline" style="align-self: center;"> 
											บาท
										</label>
							...
							<div class="row" style="margin-left: 10px;">
								...
								<div class="col-lg-12">
									...
									<label class="col-form-label col-lg-12" style="margin-left: -5px;">
										...
										<label class="radio-inline col-form-label  col-lg-8">
											<input type="text" class="form-control" name="S4_6_1_1_TEXT" disabled />
										</label>
									</label>
								</div>
							</div>
							...
							<div class="row" style="margin-left: 10px;">
								...
								<div class="col-lg-12">
									...
									<label class="col-form-label col-lg-12" style="margin-left: -5px;">
										...
										<label class="radio-inline col-form-label  col-lg-8">
											<input type="text" class="form-control" name="S4_6_2_1_TEXT" disabled />
										</label>
									</label>
								</div>
							</div>
							...
							<div class="row">
								<label for="42" class="col-form-label">4.7 (เฉพาะกรณีที่แจ้งต่อเจ้าหน้าที่) ท่านมีความพึงพอใจต่อการดำเนินงานของเจ้าหน้าที่ต่อการรับแจ้งเหตุของท่านมากน้อยเพียงใด</label>
								<div class="col-lg-12">
									<label class="radio-inline col-form-label  col-lg-2">
										<input type="radio" id="421" name="S4_2" value="1"> (1) บิดา/มารดา
									</label>
	...
	<script>
		...
		$('input[name="S1_1_2"]').on('change', function() {
			if ($(this).val() === '9') {
				$('input[name="S1_1_2_TEXT"]').prop('disabled', false);
			} else {
				$('input[name="S1_1_2_TEXT"]').prop('disabled', true);
			}
		});

		$('input[name="S1_1_3"]').on('change', function() {
			if ($(this).val() === '1') {
				$('input[name="S1_1_3_1_TEXT_1"]').prop('disabled', false);
				$('input[name="S1_1_3_1_TEXT_2"]').prop('disabled', false);
				$('input[name="S1_1_3_1_TEXT_3"]').prop('disabled', false);
				$('input[name="S1_1_3_2_TEXT_1"]').prop('disabled', true);
				$('input[name="S1_1_3_2_TEXT_2"]').prop('disabled', true);
				$('input[name="S1_1_3_2_TEXT_3"]').prop('disabled', true);
				$('input[name="S1_1_3_2_TEXT_4"]').prop('disabled', true);
				$('input[name="S1_1_3_2_TEXT_5"]').prop('disabled', true);
			} else {
				$('input[name="S1_1_3_1_TEXT_1"]').prop('disabled', true);
				$('input[name="S1_1_3_1_TEXT_2"]').prop('disabled', true);
				$('input[name="S1_1_3_1_TEXT_3"]').prop('disabled', true);
				$('input[name="S1_1_3_2_TEXT_1"]').prop('disabled', false);
				$('input[name="S1_1_3_2_TEXT_2"]').prop('disabled', false);
				$('input[name="S1_1_3_2_TEXT_3"]').prop('disabled', false);
				$('input[name="S1_1_3_2_TEXT_4"]').prop('disabled', false);
				$('input[name="S1_1_3_2_TEXT_5"]').prop('disabled', false);
			}
		});

		$('input[name="S1_1_4"]').on('change', function() {
			if ($(this).val() === '6') {
				$('input[name="S1_1_4_TEXT"]').prop('disabled', false);
			} else {
				$('input[name="S1_1_4_TEXT"]').prop('disabled', true);
			}
		});

		$('input[name="S3_4"]').on('change', function() {
			if ($(this).val() === '8') {
				$('input[name="S3_4_TEXT"]').prop('disabled', false);
			} else {
				$('input[name="S3_4_TEXT"]').prop('disabled', true);
			}
		});

		$('input[name="S3_5"]').on('change', function() {
			if ($(this).val() === '10') {
				$('input[name="S3_5_TEXT"]').prop('disabled', false);
			} else {
				$('input[name="S3_5_TEXT"]').prop('disabled', true);
			}
		});

		$('input[name="S4_1"]').on('change', function() {
			if ($(this).val() === '1') {
				$('input[name="S4_1_TEXT"]').prop('disabled', false);
			} else {
				$('input[name="S4_1_TEXT"]').prop('disabled', true);
			}
		});

		$('input[name="S4_2"]').on('change', function() {
			if ($(this).val() === '6') {
				$('input[name="S4_2_TEXT"]').prop('disabled', false);
			} else {
				$('input[name="S4_2_TEXT"]').prop('disabled', true);
			}
		});

		$('input[name="S4_3_2"]').on('change', function() {
			if ($(this).val() === '2') {
				$('input[name="S4_3_2_TEXT"]').prop('disabled', false);
			} else {
				$('input[name="S4_3_2_TEXT"]').prop('disabled', true);
			}
		});

		$('input[name="S4_3_3"]').on('change', function() {
			if ($(this).val() === '1') {
				$('input[name="S4_3_3_1_TEXT"]').prop('disabled', false);
				$('input[name="S4_3_3_2_TEXT"]').prop('disabled', true);
				$('input[name="S4_3_3_3_TEXT"]').prop('disabled', true);
				$('input[name="S4_3_3_4_TEXT"]').prop('disabled', true);
				$('input[name="S4_3_3_5_TEXT"]').prop('disabled', true);
				$('input[name="S4_3_3_6_TEXT"]').prop('disabled', true);
				$('input[name="S4_3_3_7_TEXT"]').prop('disabled', true);
			} else if ($(this).val() === '2') {
				$('input[name="S4_3_3_2_TEXT"]').prop('disabled', false);
				$('input[name="S4_3_3_1_TEXT"]').prop('disabled', true);
				$('input[name="S4_3_3_3_TEXT"]').prop('disabled', true);
				$('input[name="S4_3_3_4_TEXT"]').prop('disabled', true);
				$('input[name="S4_3_3_5_TEXT"]').prop('disabled', true);
				$('input[name="S4_3_3_6_TEXT"]').prop('disabled', true);
				...
				$('input[name="S4_3_3_3_TEXT"]').prop('disabled', false);
				$('input[name="S4_3_3_1_TEXT"]').prop('disabled', true);
				$('input[name="S4_3_3_2_TEXT"]').prop('disabled', true);
				$('input[name="S4_3_3_4_TEXT"]').prop('disabled', true);
				$('input[name="S4_3_3_5_TEXT"]').prop('disabled', true);
				...
				$('input[name="S4_3_3_4_TEXT"]').prop('disabled', false);
				$('input[name="S4_3_3_1_TEXT"]').prop('disabled', true);
				$('input[name="S4_3_3_2_TEXT"]').prop('disabled', true);
				$('input[name="S4_3_3_3_TEXT"]').prop('disabled', true);
				$('input[name="S4_3_3_5_TEXT"]').prop('disabled', true);
				...
				$('input[name="S4_3_3_5_TEXT"]').prop('disabled', false);
				$('input[name="S4_3_3_1_TEXT"]').prop('disabled', true);
				$('input[name="S4_3_3_2_TEXT"]').prop('disabled', true);
				$('input[name="S4_3_3_3_TEXT"]').prop('disabled', true);
				$('input[name="S4_3_3_4_TEXT"]').prop('disabled', true);
				...
				$('input[name="S4_3_3_6_TEXT"]').prop('disabled', false);
				$('input[name="S4_3_3_1_TEXT"]').prop('disabled', true);
				$('input[name="S4_3_3_2_TEXT"]').prop('disabled', true);
				$('input[name="S4_3_3_3_TEXT"]').prop('disabled', true);
				$('input[name="S4_3_3_4_TEXT"]').prop('disabled', true);
				...
				$('input[name="S4_3_3_7_TEXT"]').prop('disabled', false);
				$('input[name="S4_3_3_1_TEXT"]').prop('disabled', true);
				$('input[name="S4_3_3_2_TEXT"]').prop('disabled', true);
				$('input[name="S4_3_3_3_TEXT"]').prop('disabled', true);
				$('input[name="S4_3_3_4_TEXT"]').prop('disabled', true);
		...
		$('input[name="S4_6_1_1"]').on('change', function() {
			if ($(this).val() === '4') {
				$('input[name="S4_6_1_1_TEXT"]').prop('disabled', false);
			} else {
				$('input[name="S4_6_1_1_TEXT"]').prop('disabled', true);
			}
		});

		$('input[Id="462118"]').on('change', function () {
			if ($(this).is(":checked")) {
				$('input[name="S4_6_2_1_TEXT"]').prop('disabled', false);
			} else {
				$('input[name="S4_6_2_1_TEXT"]').prop('disabled', true);
			}
		});
